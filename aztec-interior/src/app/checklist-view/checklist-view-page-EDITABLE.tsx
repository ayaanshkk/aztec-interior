...
export default function ChecklistViewPage() {
  ...
  const addAdditionalDoor = () => {
    ...
    setFormData({
      ...formData,
      additional_doors: [...(formData.additional_doors || []), { door_style: "", door_color: "", quantity: "" }],
    });
  };
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-3">
                        {standardAppliances.map((appliance, idx) => {
                          ...
                          // Skip completely empty appliances in view mode
              ...
              {!isEditing || signatureMode === "view" ? (
                ...
                <div>
                  {signatureMode === "upload" ? (
                    <div className="mb-4 rounded-lg border-2 border-dashed border-gray-300 bg-white p-6 text-center">
                      <input
                        type="file"
                        accept="image/*"
                        className="hidden"
