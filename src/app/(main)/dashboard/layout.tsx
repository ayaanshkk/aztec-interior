...
import { ArraySafetyBoundary } from "@/components/ArraySafetyBoundary"; // ✅ ADD THIS
...
export default async function DashboardLayout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <ProtectedRoute>
      <ArraySafetyBoundary> {/* ✅ ADD THIS - Catches array errors globally */}
      ...
      </ArraySafetyBoundary> {/* ✅ CLOSE IT HERE */}
    </ProtectedRoute>
  );
}