...
export default function ViewInvoicePage() {
  ...
  if (!invoice) return <div className="flex min-h-screen items-center justify-center"><p>Invoice not found</p></div>;
      ...
      <div className="mx-auto max-w-6xl px-8 py-8">
        ...
        <div className="mb-6">
          <table className="w-full border-collapse">
            <tbody>
              {[
                { label: "INVOICE DATE:", key: "invoice_date", display: displayInvoiceDate, type: "date" },
